...
after "deploy:create_symlink" do
  ...
  # If there is a symbolic link to 'site/slider', delete it. Irregardless, create a new symbolic link to 'site/slider'.
  run "cd #{live_root} && if [ -h site/slider ]; then rm site/slider; fi && ln -sf #{current_path} ./site/slider"
end
