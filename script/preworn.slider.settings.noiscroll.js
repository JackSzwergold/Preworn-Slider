...
$(document).ready(function() {
    ...
    window.slider_params['iscroll_mode'] = (is_touch_device && is_apple_touch_device) ? true : false; // if set to true it uses iScroll; otherwise it uses the jQuery functions
    ...
    window.slider_params['adjust_slider_height'] = (is_touch_device && is_apple_touch_device) ? 'full' : ''; // sets different options for adjusting the slider height; default is '' (empty) to leave the heigh as is
